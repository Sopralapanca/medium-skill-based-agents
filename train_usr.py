...
max_training_steps = _config.get("max_training_steps", 10000)

all_tr_eps = []
all_val_eps = []
ENVS = _config.get("ENVS", [])
steps_in_get_episodes = 5000 # if 1000 will raise error too few episodes collected
...
state_rep_model = UnsupervisedStateRepresentationModel(
    observation=all_tr_eps[0][0], max_training_steps=max_training_steps
)
